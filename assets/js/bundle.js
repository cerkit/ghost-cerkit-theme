...
$(bindLinkIcons);
/* http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript+aspnet+csharp+handlebars+http+json+less+php+sql&plugins=line-highlight+line-numbers+wpd */
